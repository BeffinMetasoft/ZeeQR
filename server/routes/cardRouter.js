...
const { getSingleCard, addLocations, reviewQrDetails, contactCardDetails, addContactCardLocations, addReviewCardLocations, getLanguages, redirectioQrDetails, addRedirectionQrLocations } = require('../controllers/cardController')
...
router.post('/redirectionQr-interface/:id',verifyUrlQRDomain, redirectioQrDetails)   //contact interface view
