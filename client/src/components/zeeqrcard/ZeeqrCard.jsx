...
Matte Black</p>
        ...
        <img className='place-items-center justify-content-center' src={rotate}></img></div>
  ...
  <label class="">
    <input type="text" value="First Name" disabled class="mt-1 block w-[236px] px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
...
<form className='ml-7'>
  ...
  <label class="">
    ...
    <input type="text" value="Company Name / Tagline (Optional)" disabled class="mt-1 block w-[236px] px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
      focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500
      disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none
      invalid:border-pink-500 invalid:text-pink-600
      focus:invalid:border-pink-500 focus:invalid:ring-pink-500
...
<form className='ml-7'>
  ...
  <label class="">
    ...
    <input type="text" value="Add your Logo" disabled class="mt-1 block w-[236px] px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
      focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500
      disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none
      invalid:border-pink-500 invalid:text-pink-600
      focus:invalid:border-pink-500 focus:invalid:ring-pink-500
...
<form  className='ml-7'>
  ...
  <label class="">
    ...
    <input type="text" value="Save and Next" disabled class="mt-1 block w-[236px] px-3 py-2  border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
      focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500
