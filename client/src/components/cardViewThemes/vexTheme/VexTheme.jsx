...
import VerticalSlideSMVex from "../Common/socialMedia/VerticalSlideSMVex";
      ...
      <div className="relative ">
        ...
        <div className="digitalcontainer4 fixed h-screen overflow-auto scrollbar-hide " style={imageStyle}>
          ...
          <div className=" mt-5 mx-3  ">
                ...
                {companyLogo ? (
                  checkLogo ? (
                    ...
                    >
                      ...
                      {SMediaPostion?.pos5 || socialMedias.length >= 5 &&
                ...
                <div className="bg-gradient-to-b from-[#383B42] to-[#000000] w-1/2 max-h-[438px] rounded-[22px] flex items-center justify-center ">
                  <div className="flex items-center justify-center ">
                    {(socialMedias && socialMedias?.length !== 0) ?
                      <VerticalSlideSMVex preview={preview} />
                      :
            ...
            {
              ((SMediaPostion?.pos5 || socialMedias?.length >= 5 ) && checkLogo && companyLogo) || ((socialMedias && socialMedias?.length !== 0) ? socialMedias?.length < 5 : !SMediaPostion?.pos5) ?
                <Link
                  to={`${preview ? contactDetails?.locationUrl : ""}`}
                  target={`${preview ? "_blank" : ""}`}
                >
          ...
          <div className='fixed bottom-5 lg:left-[45%] left-[25%]  flex items-center gap-2 justify-center my-2 '>
            ...
            <div >
              <Link to={`${preview ? vCard : ''}`}>
                <svg width="50" height="50" viewBox="0 0 50 50" fill="none" className="shadow-xl" xmlns="http://www.w3.org/2000/svg">
                  <rect width="50" height="50" rx="12" fill="white" className="shadow-xl" />
            ...
            <div  >
              <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg" className="cursor-pointer shadow-xl" onClick={() => setQrModal(true)}>
                <rect width="50" height="50" rx="12" fill="white" className="shadow-xl" />
            ...
            <div>
              <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg" className="cursor-pointer shadow-xl" onClick={handleShare}>
                <rect width="50" height="50" rx="12" fill="white" className="shadow-xl" />
