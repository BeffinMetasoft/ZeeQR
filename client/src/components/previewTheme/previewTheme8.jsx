...
import mail11 from "../../assests/img/01mail.png";
import loc14 from "../../assests/img/02loc.png";
  ...
  return (
    <div>
      <section className="previewWrap">
        ...
        <div className="previewContainer8">
