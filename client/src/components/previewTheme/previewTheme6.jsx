        ...
        <div>
            <section className="previewWrap">
                ...
                <div className="previewContainer4">
                    ...
                    <div className="logo" style={{backgroundColor:'#E2E2E2', minHeight:'200px', textAlign:'center',fontSize:'2.7em',fontWeight:'bold', color:'black'}}>YOUR LOGO</div>
