...
import image from "../../assests/img/bg.png";
import Card from "react-bootstrap/Card";
import mail11 from "../../assests/img/mail1.png";
import loc14 from "../../assests/img/location1.png";
import img1 from "../../assests/img/logo ur.png";

import { color, fontWeight, textAlign } from "@mui/system";
// import Contacts from 'react-native-contacts';
// import ContactsModule from './ContactModule'

function PreviewTheme7({ card }) {
  ...
  return (
    <div>
      <section className="previewWrap">
        <span
          className="qr-code fixed bottom-0 center-0 z-10 ml-[330px] md:ml-[800px] border rounded-full bg-black text-white p-2 my-6"
        ...
        <div className="previewContainer5">
          <div className="header">
            <img src={logo} alt="logo zeeqr" />
            <Link className="btn" to={"https://zeeqr.co/"} target="_blank">
              Get your card
            </Link>
          </div>
          ...
          <div className="userDetails">
            ...
            {/* </figure> */}
              <div className="text" style={{fontSize:"22px", color:"white",fontWeight: 'bold'}}>Your Complete Name
              <div className="text" style={{fontSize:"15px" , fontFamily:"bold"}}>Designations</div>
        
              </div>
              <div className="user ">
                <img className="bg-black" style={{border: "5px solid #555;"}}src={img1} alt="" />
              </div>

            {/* <div className="user " style={{ backgroundColor: "grey" }}> */}
              {/* <Card>
                <div className="clearfix">
                  <div className="user" style={{ backgroundColor: "grey" }} />
                </div>
                <Card.Body>
                  <Card.Text>Designations</Card.Text>
                </Card.Body>
              </Card> */}
          ...
          <div className="contactOptions">
            <div className="buttons">
              <Link className="addTo" to={`${card.vCard}`}>
                Add to contacts
              </Link>
              <Link onClick={handleShare} className="sharebuttons">
                <img src={share} alt="" />
                Share it{" "}
              </Link>
            </div>
            ...
            >
              <img src={mail11} alt="" style={{ color: "white" }} />
              {card.email}
            </Link>
            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-transparent outline-none focus:outline-none">
                ...
                >
                  ...
                  <button
                    className="cursor-pointer absolute top-0 right-0 mt-8   mr-5 text-black hover:text-gray-600 transition duration-150 ease-in-out rounded focus:ring-2 focus:outline-none focus:ring-gray-600"
                    onClick={() => setQrModal(false)}
                  >
                    <svg
