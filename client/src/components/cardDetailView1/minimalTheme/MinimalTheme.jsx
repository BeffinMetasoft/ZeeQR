...
function MinimalTheme({ card }) {
    ...
    return (
        <div>
            <section className="previewWrap14" style={{ backgroundColor: `${card.color ? card.color : 'white'}`, color: `${card.color ? card.color : "black"}` }} >
                <span
                ...
                <div className="previewContainer14"  >
                    ...
                    <div className="userDetails">
                        <figure>
                            <img className="userDetails-img" src={card.profileImage} alt="" />
                        </figure>
                        <div className="user">
                            <h1>{card.name}</h1>
                    ...
                    <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none" >
                        <div className="relative w-auto my-6 mx-auto max-w-3xl">
                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-transparent outline-none focus:outline-none">
                                ...
                                {/*body*/}
                                <div className="popup-container3 justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50  outline-none focus:outline-none" id="modal"  >
                                    ...
                                    <div className="userDetails">
                                        ...
                                        {!showResults ?
                                            <div className='addToHome3' onClick={onClick}  >Add to Home Screen</div>
                                            :
                                            <img className='addtoHomeImage3' src={addtoHome} alt='' />}
